...
class SpinalContext extends SpinalNode_1.SpinalNode {
     ...
     */
    addChild(child, relationName, relationType = SpinalRelationFactory_1.SPINAL_RELATION_PTR_LST_TYPE) {
     ...
     * @returns {Promise<SpinalNode>} The child node in a promise
     */
    addChildInContext(child, relationName, relationType = SpinalRelationFactory_1.SPINAL_RELATION_PTR_LST_TYPE, context = this) {
