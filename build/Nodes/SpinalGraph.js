...
class SpinalGraph extends SpinalNode_1.SpinalNode {
    ...
    addContext(context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.addChild(context, HAS_CONTEXT_RELATION_NAME, SpinalRelationFactory_1.SPINAL_RELATION_TYPE);
        });
    }
    /**
    ...
    getContext(name) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const children = yield this.getChildren([HAS_CONTEXT_RELATION_NAME]);
