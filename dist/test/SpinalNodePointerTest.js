...
describe('SpinalNodePointer', function () {
    ...
    describe('How to set/unset the pointer', function () {
        describe('How to use setElement', function () {
            it('should set an element and update pointedId and pointedType', function () { return __awaiter(void 0, void 0, void 0, function () {
                var ptr, elem;
            ...
            it('should set an element but not update pointedId and pointedType', function () { return __awaiter(void 0, void 0, void 0, function () {
                var ptr, elem;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
        ...
        describe('How to use load', function () {
            it('should load the node to which the pointer is pointing', function () { return __awaiter(void 0, void 0, void 0, function () {
                var ptr, elem;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
