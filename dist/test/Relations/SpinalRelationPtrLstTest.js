...
describe('SpinalRelationPtrLst', function () {
    describe('How to use the constructor', function () {
        it('should create an empty opject FileSystem._sig_server === false', function () {
            spinal_core_connectorjs_type_1.FileSystem._sig_server = false;
            var rel = new src_1.SpinalRelationPtrLst(DEFAULT_NODE, DEFAULT_RELATION_NAME);
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        rel = new src_1.SpinalRelationPtrLst(parent, DEFAULT_RELATION_NAME);
                        assert.strictEqual(rel.getName().get(), DEFAULT_RELATION_NAME);
        ...
        it('should throw an error if the parent or the name is missing', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                testConstructor = src_1.SpinalRelationPtrLst;
        ...
        it('should throw an error if the parent is not a SpinalNode', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                parent1 = [];
                assert.throws(function () {
                    new src_1.SpinalRelationPtrLst(parent1, DEFAULT_RELATION_NAME);
                }, TypeError);
                parent2 = new spinal_core_connectorjs_type_1.Model();
                assert.throws(function () {
                    new src_1.SpinalRelationPtrLst(parent2, DEFAULT_RELATION_NAME);
                }, TypeError);
                return [2 /*return*/];
            });
        }); });
    ...
    describe('How to get informations about the relation', function () {
        describe('How to use getChildrenIds', function () {
            it('should return the ids of all children', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            rel = new src_1.SpinalRelationPtrLst(DEFAULT_NODE, DEFAULT_RELATION_NAME);
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            relation = new src_1.SpinalRelationPtrLst(DEFAULT_NODE, DEFAULT_RELATION_NAME);
        ...
        describe('How to use getType', function () {
            it("should return the relation's type", function () {
                var rel = new src_1.SpinalRelationPtrLst(DEFAULT_NODE, DEFAULT_RELATION_NAME);
                assert.strictEqual(rel.getType(), src_1.SPINAL_RELATION_PTR_LST_TYPE);
            });
        });
    });
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            arr = [];
                            return [4 /*yield*/, rel.addChild(arr)];
                        case 2:
                            _a.sent();
                            return [3 /*break*/, 4];
                        case 3:
    ...
    describe('How to remove children', function () {
        describe('How to use removeChild', function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            rel = parentNode._createRelation(DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_PTR_LST_TYPE);
            ...
            it('should throw an error if nodes is not an array', function () { return __awaiter(_this, void 0, void 0, function () {
                var relation, error, argTest, e_7;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            relation = new src_1.SpinalRelationPtrLst(DEFAULT_NODE, DEFAULT_RELATION_NAME);
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            argTest = {};
                            return [4 /*yield*/, relation.removeChildren(argTest)];
                        case 2:
                            _a.sent();
                            return [3 /*break*/, 4];
                        case 3:
        ...
        describe('How to use removeChildren', function () {
            ...
            it('should delete some of the given children', function () { return __awaiter(_this, void 0, void 0, function () {
                var rel, node1, node2, node3, node4, error, e_8, children;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            rel = new src_1.SpinalRelationPtrLst(DEFAULT_NODE, DEFAULT_RELATION_NAME);
...
//# sourceMappingURL=SpinalRelationPtrLstTest.js.map