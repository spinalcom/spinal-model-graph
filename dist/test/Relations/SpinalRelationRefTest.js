...
describe('SpinalRelationRef', function () {
    describe('How to use the constructor', function () {
        it('should create an empty object FileSystem._sig_server === false', function () {
            ...
            var rel = new src_1.SpinalRelationRef(DEFAULT_NODE, DEFAULT_RELATION_NAME);
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        rel = new src_1.SpinalRelationRef(parent, DEFAULT_RELATION_NAME);
                        assert.strictEqual(rel.getName().get(), DEFAULT_RELATION_NAME);
        ...
        it('should throw an error if the parent or the name is missing', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                assert.throws(function () {
                    new src_1.SpinalRelationRef();
                }, TypeError);
                assert.throws(function () {
                    new src_1.SpinalRelationRef(undefined, DEFAULT_RELATION_NAME);
                }, TypeError);
                assert.throws(function () {
                    new src_1.SpinalRelationRef(DEFAULT_NODE);
                }, TypeError);
                return [2 /*return*/];
            });
        }); });
        it('should throw an error if the parent is not a SpinalNode', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                parent1 = [];
                assert.throws(function () {
                    new src_1.SpinalRelationRef(parent1, DEFAULT_RELATION_NAME);
                }, TypeError);
                parent2 = new spinal_core_connectorjs_type_1.Model();
                assert.throws(function () {
                    new src_1.SpinalRelationRef(parent2, DEFAULT_RELATION_NAME);
                }, TypeError);
                return [2 /*return*/];
            });
        }); });
    ...
    describe('How to get informations about the relation', function () {
        describe('How to use getChildrenIds', function () {
            it('should return the ids of all children', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            rel = new src_1.SpinalRelationRef(DEFAULT_NODE, DEFAULT_RELATION_NAME);
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            relation = new src_1.SpinalRelationRef(DEFAULT_NODE, DEFAULT_RELATION_NAME);
        ...
        describe('How to use getType', function () {
            it("should return the relation's type", function () {
                var rel = new src_1.SpinalRelationRef(DEFAULT_NODE, DEFAULT_RELATION_NAME);
                assert.strictEqual(rel.getType(), src_1.SPINAL_RELATION_TYPE);
            });
        });
    });
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            value = [];
                            return [4 /*yield*/, rel.addChild(value)];
                        case 2:
                            _a.sent();
                            return [3 /*break*/, 4];
                        case 3:
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            rel = parentNode._createRelation(DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE);
...
//# sourceMappingURL=SpinalRelationRefTest.js.map