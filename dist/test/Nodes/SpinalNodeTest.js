...
const DEFAULT_ELEMENT = new spinal_core_connectorjs_type_1.Model();
DEFAULT_ELEMENT.add_attr({
    name: DEFAULT_ELEMENT_NAME,
});
const DEFAULT_NODE = new src_1.SpinalNode(CUSTOM_SPINAL_NODE_NAME);
describe('SpinalNode', () => {
    describe('How to use the constructor', () => {
        ...
        it('should create spinal a new SpinalNode with a specific name.', () => {
            const node = new src_1.SpinalNode(CUSTOM_SPINAL_NODE_NAME);
        ...
        it('should create a new SpinalNode with specific name and type.', () => {
            const node = new src_1.SpinalNode(CUSTOM_SPINAL_NODE_NAME, CUSTOM_SPINAL_NODE_TYPE);
            assert.strictEqual(node.getName().get(), CUSTOM_SPINAL_NODE_NAME, 'By setting the first argument of the construct the name should be setElement.');
        ...
        it('should create a new SpinalNode with specific name, type and element', async () => {
            const node = new src_1.SpinalNode(CUSTOM_SPINAL_NODE_NAME, CUSTOM_SPINAL_NODE_TYPE, new src_1.SpinalNode());
            assert.strictEqual(node.getName().get(), CUSTOM_SPINAL_NODE_NAME, 'By setting the first argument of the construct the name should be setElement.');
            assert.strictEqual(node.getType().get(), CUSTOM_SPINAL_NODE_TYPE, 'By setting the second argument of the construct the type should be setElement.');
            const elt = await node.getElement();
    ...
    describe('How to get/set information about the node', () => {
        ...
        describe('How to getElement', () => {
            it('should return the DEFAULT_ELEMENT', async () => {
                const node = new src_1.SpinalNode(CUSTOM_SPINAL_NODE_NAME, CUSTOM_SPINAL_NODE_TYPE, DEFAULT_ELEMENT);
                const elt = await node.getElement();
        ...
        describe('How to use getNbChildren', () => {
            ...
            it('should return 2', async () => {
                ...
                await node.removeChild(child2, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE);
                const res = node.getNbChildren();
        ...
        describe('How to use belongsToContext', () => {
            it('should return true', async () => {
                ...
                await parent.addChildInContext(child, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE, context);
    ...
    describe("How to get information about the node's relations", () => {
        describe('How to use hasRelation', () => {
            it('should return true', async () => {
                const node = new src_1.SpinalNode();
                await node.addChild(DEFAULT_NODE, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE);
        ...
        describe('How to use getRelationNames', () => {
            ...
            it("shouldn't return duplicates if there are different " +
                'relation with the same names but different types', async () => {
                const node = new src_1.SpinalNode();
                const child1 = new src_1.SpinalNode();
                const child2 = new src_1.SpinalNode();
                const child3 = new src_1.SpinalNode();
    ...
    describe('How to add a child to the node', () => {
        describe('How to use addChild', () => {
            ...
            it('should add a child to the node with a relation type SPINAL_RELATION_LST_PTR_TYPE', async () => {
                const node = new src_1.SpinalNode();
                await node.addChild(DEFAULT_NODE, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_LST_PTR_TYPE);
                assert.strictEqual(typeof node !== 'undefined', true);
            ...
            it('should return the node added to the relation', async () => {
                ...
                const childModel = new spinal_core_connectorjs_type_1.Model();
                const res1 = await node.addChild(childNode, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE);
                assert.strictEqual(res1, childNode);
                const res2 = await node.addChild(childModel, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE);
            ...
            it('should throw an error if the child is not a model', async () => {
                ...
                let error = false;
                try {
                    await node.addChild([], DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
            ...
            it('should throw an error if the relation name is missing', async () => {
                ...
                let error = false;
                try {
                    await node.addChild(DEFAULT_NODE, undefined, src_1.SPINAL_RELATION_TYPE);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
            ...
            it('should throw an error if the relation name is not a string', async () => {
                ...
                let error = false;
                try {
                    await node.addChild(DEFAULT_NODE, 1, src_1.SPINAL_RELATION_TYPE);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
        ...
        describe('How to use addChildInContext', () => {
            it('Should add a child to a node', async () => {
                const node = new src_1.SpinalNode();
                const context = new src_1.SpinalContext();
                await node.addChildInContext(DEFAULT_NODE, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE, context);
                assert.strictEqual(typeof node !== 'undefined', true);
                assert.strictEqual(node.hasRelation(DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE), true);
                const children = await node.getChildren([DEFAULT_RELATION_NAME]);
                assert.strictEqual(children.length, 1);
            ...
            it('should return the node added to the relation', async () => {
                const node = new src_1.SpinalNode(DEFAULT_RELATION_NAME);
                const context = new src_1.SpinalContext();
                const childNode = new src_1.SpinalNode();
                const childModel = new spinal_core_connectorjs_type_1.Model();
                const res1 = await node.addChildInContext(childNode, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE, context);
                assert.strictEqual(res1, childNode);
                const res2 = await node.addChildInContext(childModel, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE, context);
                const res2Elem = await res2.getElement();
                assert.strictEqual(res2Elem, childModel);
            });
            it('should throw an error if you try to add the same node twice', async () => {
            ...
            it('should throw an error if the child is not a model', async () => {
                ...
                let error = false;
                try {
                    await node.addChildInContext([], DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE, context);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
            ...
            it('should throw an error if the relation name is missing', async () => {
                ...
                let error = false;
                try {
                    await node.addChildInContext(DEFAULT_NODE, undefined, src_1.SPINAL_RELATION_TYPE, context);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
            ...
            it('should throw an error if the relation name is not a string', async () => {
                ...
                let error = false;
                try {
                    await node.addChildInContext(DEFAULT_NODE, 1, src_1.SPINAL_RELATION_TYPE, context);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
            ...
            it('should throw an error if the context is missing', async () => {
                ...
                let error = false;
                try {
                    await node.addChildInContext(DEFAULT_NODE, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_LST_PTR_TYPE);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
            ...
            it('should throw an error if the context is not a SpinalContext', async () => {
                ...
                let error = false;
                try {
                    await node.addChildInContext(DEFAULT_NODE, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_LST_PTR_TYPE, 1);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
    ...
    describe('How to remove child(s)', () => {
        describe('How to use removeChild', () => {
            it('should remove the child', async () => {
                const node = new src_1.SpinalNode();
                await node.addChild(node, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE);
                await node.removeChild(node, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE);
            ...
            it('should throw if the relation name is missing', async () => {
                ...
                let error = false;
                try {
                    await node.removeChild(node, undefined, src_1.SPINAL_RELATION_TYPE);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
            ...
            it('should throw if the relation name is not a string', async () => {
                ...
                let error = false;
                try {
                    await node.removeChild(node, 1, src_1.SPINAL_RELATION_TYPE);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
            ...
            it("should throw if the relation doesn't exist", async () => {
                ...
                await node.addChild(node, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE);
                try {
                    await node.removeChild(node, `${DEFAULT_RELATION_NAME}1`, src_1.SPINAL_RELATION_TYPE);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
                ...
                error = false;
                try {
                    await node.removeChild(node, DEFAULT_RELATION_NAME, `${src_1.SPINAL_RELATION_TYPE}1`);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
            ...
            it('should throw if the node is missing', async () => {
                ...
                let error = false;
                try {
                    await node.removeChild(undefined, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
        ...
        describe('How to use removeChildren', () => {
            it('should delete all of the children', async () => {
                ...
                await parent.removeChildren([node1, node2, node3], DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE);
            ...
            it('should throw an error if nodes is not an array', async () => {
                ...
                let error = false;
                try {
                    await parent.removeChildren(1, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
            ...
            it('should throw if the relation name is missing', async () => {
                ...
                let error = false;
                try {
                    await node.removeChildren([], undefined, src_1.SPINAL_RELATION_TYPE);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
            ...
            it('should throw if the relation name is not a string', async () => {
                ...
                let error = false;
                try {
                    await node.removeChildren([], 1, src_1.SPINAL_RELATION_TYPE);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
            ...
            it("should throw if the relation doesn't exist", async () => {
                ...
                const child = new src_1.SpinalNode();
                let error = false;
                await node.addChild(child, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE);
                try {
                    await node.removeChildren([], `${DEFAULT_RELATION_NAME}1`, src_1.SPINAL_RELATION_TYPE);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
                ...
                error = false;
                try {
                    await node.removeChildren(node, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_LST_PTR_TYPE);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
        ...
        describe('How to use removeRelation', () => {
            it('should remove the relation', async () => {
                const parent = new src_1.SpinalNode();
                const child = new src_1.SpinalNode();
                await parent.addChild(child, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE);
                await parent.removeRelation(DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE);
            ...
            it('should throw if the relation name is missing', async () => {
                ...
                let error = false;
                try {
                    await node.removeRelation(undefined, src_1.SPINAL_RELATION_TYPE);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
            ...
            it('should throw if the relation name is not a string', async () => {
                ...
                let error = false;
                try {
                    await node.removeRelation(node, 1, src_1.SPINAL_RELATION_TYPE);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
            ...
            it("should throw if the relation doesn't exist", async () => {
                ...
                await node.addChild(node, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE);
                try {
                    await node.removeRelation(`${DEFAULT_RELATION_NAME}1`, src_1.SPINAL_RELATION_TYPE);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
                ...
                error = false;
                try {
                    await node.removeRelation(DEFAULT_RELATION_NAME, `${src_1.SPINAL_RELATION_TYPE}1`);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
        ...
        describe('How to use removeFromGraph', () => {
            it('should remove the node from its parents', async () => {
                ...
                await parentNode.addChild(node, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE);
    ...
    describe('How to get related nodes', () => {
        describe('How to use getChild', () => {
            it('should get the child', async () => {
                ...
                const child = new src_1.SpinalNode();
                await parent.addChild(child, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE);
                const res = await parent.getChild(node => node === child, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE);
            ...
            it('should use the relation name', async () => {
                ...
                const res = await parent.getChild(() => true, `${DEFAULT_RELATION_NAME}3`, src_1.SPINAL_RELATION_TYPE);
            ...
            it('should use the relation type', async () => {
                ...
                const res = await parent.getChild(() => true, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_PTR_LST_TYPE);
                assert.strictEqual(res, child3);
            });
            it("should return undefined if the child doesn't exist", async () => {
                ...
                const child = new src_1.SpinalNode();
                await parent.addChild(child, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE);
                const res = await parent.getChild(() => false, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE);
            ...
            it('should throw if the relation name is missing', async () => {
                ...
                await parent.addChild(child, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE);
                try {
                    await parent.getChild(() => true, undefined, src_1.SPINAL_RELATION_TYPE);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
            ...
            it('should throw if the relation name is not a string', async () => {
                ...
                await parent.addChild(child, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE);
                try {
                    await parent.getChild(() => true, 1, src_1.SPINAL_RELATION_TYPE);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
            ...
            it("should throw if the relation doesn't exist", async () => {
                ...
                await parent.addChild(child, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_TYPE);
                try {
                    await parent.getChild(() => true, `${DEFAULT_RELATION_NAME}1`, src_1.SPINAL_RELATION_TYPE);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
                ...
                error = false;
                try {
                    await parent.getChild(() => true, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_LST_PTR_TYPE);
                }
                catch (e) {
                    error = true;
                    assert(e instanceof Error);
        ...
        describe('How to use getChildrenInContext', () => {
            it("should return the node's child", async () => {
                ...
                const parent = new src_1.SpinalNode();
                const child = new src_1.SpinalNode();
                await parent.addChildInContext(child, DEFAULT_RELATION_NAME, src_1.SPINAL_RELATION_PTR_LST_TYPE, context);
        ...
        describe('How to use getParents', () => {
            ...
            it('should return some parents', async () => {
                const parentNode1 = new src_1.SpinalNode();
                const parentNode2 = new src_1.SpinalNode();
                const childNode = new src_1.SpinalNode();
                await Promise.all([
