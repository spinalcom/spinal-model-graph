import { SpinalGraph, SpinalNode, SpinalContext, SPINAL_RELATION_TYPE } from '../../build/index';
import { SpinalRelationRef } from '../../build/Relations/SpinalRelationRef';
  ...
  describe('How to get informations about the relation', () => {
    ...
    describe('How to use getType', () => {
      it("should return the relation's type", () => {
        ...
        assert.strictEqual(rel.getType(), SPINAL_RELATION_TYPE);
      });
    });
  });
